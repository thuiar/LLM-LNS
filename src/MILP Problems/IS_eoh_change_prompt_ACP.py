...
class GetPrompts:
    ...
    def __init__(self):
        ...
        This corresponds to the Indepent Set MILP problem, where all decision variables are binary (0-1 variables), and all constraints are in the form of LHS \u2264 RHS.\
